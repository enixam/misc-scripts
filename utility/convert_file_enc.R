# This function converts the encoding of text files (Excel files are not supported) 
# By default, it uses `readr::guess_encoding` to determine the encoding of the original file
...
convert_file_enc <- function(path, from = "", to = "UTF-8") {
